...
email <input type='text' name='email' value='kavya.br@yahoo.in'><br>
<input type='submit' name='submit' value='submit'>
</form>
<hr>
<form method='post' action='profile_by_trans_id.php'>
<b>Create Customer Profile From Transaction ID</b><br>
Transaction ID <input type='text' name='old_trans_id' value='2229011307'><br> <!--Transation ID created by AIM-->
<input type='submit' name='submit' value='submit'>
</form>
<hr>
